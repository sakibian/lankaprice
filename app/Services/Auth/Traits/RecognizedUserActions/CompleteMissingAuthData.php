...
namespace App\Services\Auth\Traits\RecognizedUserActions;
...
trait CompleteMissingAuthData
{
	 ...
	 */
	protected function completeMissingAuthData($post = null, User|null $user = null): JsonResponse
	{
		$data = [
			'success' => false,
			'message' => null,
