...
trait RecognizedUserActions
{
	use CompleteMissingAuthData;
	 ...
	 * @return void
	 */
	protected function findAndMatchPostsToUser($user): void
	{
		if (empty($user)) {
			return;
		}
	 ...
	 * @return void
	 */
	protected function findAndMatchUserToPost($post): void
	{
		if (empty($post)) {
			return;
		}
