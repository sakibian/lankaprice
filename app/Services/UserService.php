...
class UserService extends BaseService
{
	...
	use Register, Update, Delete, Settings, Photo, DarkMode, Stats;
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function updateSettings($id, UserSettingsRequest $request): JsonResponse
	{
		return $this->updateUserSettings($id, $request);
	}
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function setDarkMode($userId, Request $request): JsonResponse
	{
		return $this->setDarkModeForUser($userId, $request);
	}
}
