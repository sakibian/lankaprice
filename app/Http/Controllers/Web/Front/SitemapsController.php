...
class SitemapsController extends FrontController
{
	 ...
	 * @return mixed
	 */
	public function getAllCountriesSitemapIndex(): mixed
	{
	 ...
	 * @return mixed
	 */
	public function getSitemapIndexByCountry(string $countryCode = null): mixed
	{
	 ...
	 * @return mixed
	 */
	public function getPagesSitemapByCountry(string $countryCode = null): mixed
	{
		if (empty($countryCode)) {
			$countryCode = config('country.code');
		}
	 ...
	 * @return mixed
	 */
	public function getCategoriesSitemapByCountry(string $countryCode = null): mixed
	{
		if (empty($countryCode)) {
			$countryCode = config('country.code');
		}
	 ...
	 * @return mixed
	 */
	public function getCitiesSitemapByCountry(string $countryCode = null): mixed
	{
		if (empty($countryCode)) {
			$countryCode = config('country.code');
		}
	 ...
	 * @return mixed
	 */
	public function getListingsSitemapByCountry(string $countryCode = null): mixed
	{
		if (empty($countryCode)) {
			$countryCode = config('country.code');
		}
