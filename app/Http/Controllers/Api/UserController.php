...
class UserController extends BaseController
{
	...
	{
		return $this->userService->updateSettings($id, $request);
	}
	 ...
	 *
	 * @bodyParam dark_mode int required The user's dark mode value. Example: 0 or 1
	 *
	 * @urlParam id int required The user's ID. Example: 999999
	 *
	 * @param $id
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function setDarkMode($id, Request $request): JsonResponse
	{
		return $this->userService->setDarkMode($id, $request);
	}
}
