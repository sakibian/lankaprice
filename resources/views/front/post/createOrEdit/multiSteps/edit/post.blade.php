					...
					<div class="inner-box category-content" style="overflow: visible;">
						...
						<div class="row">
							<div class="col-12">
								...
								<form class="form-horizontal" id="payableForm" method="POST" action="{{ $formActionUrl }}" enctype="multipart/form-data">
									{!! csrf_field() !!}
									...
									<fieldset>
										...
										<div class="row mb-3 pt-3">
											<div class="col-md-12 text-center">
												...
												<button id="nextStepBtn" class="btn btn-primary btn-lg">{{ $nextStepLabel }}</button>
											</div>
										</div>
