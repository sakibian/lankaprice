...
@push('crud_list_styles')
	{{-- include select2 css --}}
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/bootstrap-daterangepicker/3.1/daterangepicker.css') }}"/>
	<style>
		.input-group.date {
			width: 320px;
			max-width: 100%;
...
@push('crud_list_scripts')
	...
	<script type="text/javascript" src="{{ asset('assets/plugins/bootstrap-daterangepicker/3.1/daterangepicker.js') }}"></script>
	<script>
