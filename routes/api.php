...
Route::controller(VerificationController::class)
	...
	->group(function ($router) {
		...
		Route::get('{entityMetadataKey}/{entityId}/resend/email', 'reSendEmailVerification');
		Route::get('{entityMetadataKey}/{entityId}/resend/sms', 'reSendPhoneVerification');
		Route::get('{entityMetadataKey}/{field}/{token?}', 'verification');
	});
	...
	->group(function ($router) {
		...
		Route::middleware(['auth:sanctum'])
			->group(function ($router) {
				...
				Route::put('{id}/settings', 'updateSettings')->name('users.settings.update');
